...
MFEM_DEPENDENCIES = LIBUNWIND SIDRE LAPACK OPENMP UVM_ARRAY SUNDIALS MESQUITE\
...
MFEM_DEFINES = MFEM_VERSION MFEM_USE_MPI MFEM_USE_METIS_5 MFEM_DEBUG\
 ...
 MFEM_USE_OPENMP MFEM_USE_UVM_ARRAY MFEM_USE_MEMALLOC MFEM_TIMER_TYPE\
...
status info:
	...
	$(info MFEM_USE_UVM_ARRAY   = $(MFEM_USE_UVM_ARRAY))
